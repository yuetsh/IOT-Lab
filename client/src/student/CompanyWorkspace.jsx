    ...
    <div className="page">
      <header className="project-header">
        ...
        <p className="project-intro">
          本项目以检测小组为单位记录实验完成情况。请按活动顺序完成设备检测清单勾选，并上传检测记录截图作为成果凭证。
        </p>
      </header>

      <header className="workspace-header">
        <div>
          <p className="workspace-label">当前检测小组</p>
          <h2>{company.name}</h2>
        </div>
      ...
      <section className="workspace-section activity-section">
        <div className="section-title-row">
          ...
          <h2 className="section-heading">设备检测清单的勾选</h2>
        </div>
        <p className="section-description">
          按设备逐项确认检测任务，已完成的项目请及时勾选，进度会同步到教师后台。
        </p>
      ...
      <section className="workspace-section activity-section">
        <div className="section-title-row">
          ...
          <h2 className="section-heading">检测记录截图上传</h2>
        </div>
        <p className="section-description">
          上传检测过程或结果截图，作为本检测小组实验完成情况的补充记录。
        </p>
